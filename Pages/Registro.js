export class REGISTRO {
  ...
  Text_Msj_Succefull =
    "Te registraste con éxito, ya podés ingresar a la plataforma.";
  ...
  Nombre() {
    return cy.get(this.Input_Nombre);
  }
  Apellido() {
    return cy.get(this.Input_Apellido);
  }
  Email() {
    return cy.get(this.Input_Email);
  }
  Password() {
    return cy.get(this.Input_password);
  }
  ConfirmPassword() {
    return cy.get(this.Input_ConfirPassword);
  }
  Crear() {
    return cy.get(this.Button_Crear);
  }
  SuccefullMsj() {
    return cy.contains("p", this.Text_Msj_Succefull, { timeout: 10000 });
  }
  IrInicio() {
    return cy.get(this.Button_irInicio);
  }
  AlertNombre() {
    return cy.get(this.Alert_Nombre);
  }
  AlertApellido() {
    return cy.get(this.Alert_Apellido);
  }
  AlertEmail() {
    return cy.get(this.Alert_Email);
  }
  AlertPassword() {
    return cy.get(this.Alert_Password);
  }
  AlertConfirmPassword() {
    return cy.get(this.Alert_ConfirPassword);
  }
  AlertEmailExistente() {
    return cy.contains(this.Alert_EmailExistente, { timeout: 20000 });
  }
  AlertPasswordNoMatch() {
